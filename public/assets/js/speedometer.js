...
$.fn.myfunc = function (userPref) {
  ...
  var speedInDeg,
    ...
    speedNobeTop =
      this.defaultProperty.edgeRadius - this.defaultProperty.speedNobeH / 2,
  ...
  this.createIndicators = function () {
    for (var i = 0; i <= noOfDev; i++) {
      ...
      var induCatorLinesPosY =
        this.defaultProperty.indicatorRadius * Math.cos(0.01746 * curDig);
      var induCatorLinesPosX =
        this.defaultProperty.indicatorRadius * Math.sin(0.01746 * curDig);

      var induCatorNumbPosY =
        this.defaultProperty.indicatorNumbRadius * Math.cos(0.01746 * curDig);
      var induCatorNumbPosX =
        this.defaultProperty.indicatorNumbRadius * Math.sin(0.01746 * curDig);

      if (i % this.defaultProperty.noOfSmallDiv == 0) {
        induCatorLinesPosLeft =
          this.defaultProperty.edgeRadius - induCatorLinesPosX - 2;
        induCatorLinesPosTop =
          this.defaultProperty.edgeRadius - induCatorLinesPosY - 10;
        var tempDegInd = [
  ...
  this.changePosition = function () {
    ...
    speedInDeg =
      (self.defaultProperty.maxDeg / self.defaultProperty.maxVal) * speed +
      self.defaultProperty.initDeg;
    ...
    self.parentElem
      .find(".speedPosition")
      .html(centerVal + "<br />" + self.defaultProperty.gagueLabel);
