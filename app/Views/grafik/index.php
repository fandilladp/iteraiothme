             ...
             <div class="row h-100">
                 <div class="col-12 my-auto">
                     <div class="masthead-content text-white py-5 py-md-0">
                         <h1 class="mb-3">Komunikasi Mikrokontroller</h1>
                         <p class="mb-5">start with a simple project monitoring data sensor
                             <strong>Open Documentasion exampel projek tutorial</strong></p>
                         <div class="input-group input-group-newsletter">
                             <a href="<?= base_url('dokumentasi/index/grafik'); ?>">
