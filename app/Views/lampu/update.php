                 ...
                 <div class="container">
                     <div class="row">
                         <div class="col-md-9 col-lg-8 mx-auto">
                             ...
                             <?php endif ?>
                             <?= form_open_multipart('Lampu/update/' . $projek->id); ?>
     ...
     <script type="text/javascript">
         ...
         setTimeout(() => {
             ...
             if (value2 == 'on') {
                 ...
                 $(".viewPricing").append(
                     '<div id="remove2" class="col-lg-12 mb-5"><div class="card mb-5 mb-lg-0"><div class="card-body"><h5 class="card-title text-muted text-uppercase text-center">Lampu 2</h5><h6 class="card-price text-center">OFF</h6><hr><a class="btn btn-block btn-success text-uppercase">ON</a><a class="btn btn-block btn-danger text-uppercase">OFF</a></div></div></div>'
                 );
             }
             ...
             if (value3 == 'on') {
                 ...
                 $(".viewPricing").append(
                     '<div id="remove3" class="col-lg-12 mb-5"><div class="card mb-5 mb-lg-0"><div class="card-body"><h5 class="card-title text-muted text-uppercase text-center">Lampu 3</h5><h6 class="card-price text-center">OFF</h6><hr><a class="btn btn-block btn-success text-uppercase">ON</a><a class="btn btn-block btn-danger text-uppercase">OFF</a></div></div></div>'
                 );
             }
         }, 1000);
