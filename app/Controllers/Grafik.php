    ...
    public function created()
    {
        if ($this->session->get('isLoggedIn')) {
            if ($this->request->getPost()) {
                ...
                $this->validation->run($data, 'monitoring');
                ...
                if (!$errors) {
                    ...
                    $datavalid->role = 'grafik';
                    $datavalid->category = 'monitoring';
